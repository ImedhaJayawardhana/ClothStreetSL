            ...
            <div className="relative z-10 w-full max-w-md mx-4">
                ...
                <div className="bg-white/8 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl shadow-black/40">
                    ...
                    <div className="mb-7">
                        ...
                        <p className="text-white/50 text-sm mt-1">Make your own style with Sri Lanka's best</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        ...
                        {/* Role selector */}
                        <div>
                            <label className="block text-xs font-semibold text-white/50 uppercase tracking-wider mb-2">I am a...</label>
