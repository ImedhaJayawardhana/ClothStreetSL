...
const STATUS_MAP = {
  ...
  design_in_progress: { label: "Designing", bg: "bg-amber-100", text: "text-amber-700", dot: "bg-amber-500" },
  design_completed: { label: "Drafted", bg: "bg-amber-100", text: "text-amber-700", dot: "bg-amber-500" },
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 space-y-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { label: "Total Requests", value: stats.total, icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="2.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>, bg: "bg-amber-50", accent: "text-amber-600" },
            ...
            { label: "Quotes Received", value: stats.quoted, icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="2.5" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8v1m0 8v1" /></svg>, bg: "bg-amber-50", accent: "text-amber-600" },
        ...
        {loading ? (
          ...
          <div className="bg-slate-50/50 rounded-[40px] border-2 border-dashed border-slate-100 p-20 text-center">
            ...
            <button
              ...
              className="mt-6 px-6 py-3 bg-amber-600 text-white font-bold text-sm rounded-xl hover:bg-amber-700 transition-colors cursor-pointer shadow-lg shadow-amber-200"
            >
