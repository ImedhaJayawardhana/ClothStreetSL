                                    ...
                                    <div className="pt-4 border-t border-gray-100 mt-auto">
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            <button
                                                ...
                                                className="w-full py-2.5 px-3 bg-violet-600 hover:bg-violet-700 text-white text-sm font-semibold rounded-xl transition-colors shadow-sm shadow-violet-200 flex items-center justify-center gap-1.5 focus:ring-2 focus:ring-violet-500 focus:ring-offset-2"
                                            >
                                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <button
                                                ...
                                                className="w-full py-2.5 px-3 bg-white border border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-700 text-sm font-semibold rounded-xl transition-colors shadow-sm flex items-center justify-center gap-1.5 focus:ring-2 focus:ring-gray-200 focus:ring-offset-2"
                                            >
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={() => setContactTailor(null)}>
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            />
                            <div>
                                <h3 className="font-bold text-gray-900">{contactTailor.name}</h3>
                                <p className="text-sm text-gray-500">{contactTailor.location}</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-gray-500 truncate">{contactTailor.phone || '+94770000000'}</p>
                                </div>
                            ...
                            <button
                                ...
                                className="w-full flex items-center gap-3 p-3 bg-gray-50 hover:bg-violet-50 border border-gray-100 hover:border-violet-200 rounded-xl transition-all duration-200 group/link"
                            >
                                ...
                                <div className="flex-1 min-w-0 text-left">
                                    <p className="text-sm font-semibold text-gray-900">View Full Profile</p>
                                    <p className="text-xs text-gray-500 truncate">See portfolio & reviews</p>
                                </div>
                                <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                </svg>
