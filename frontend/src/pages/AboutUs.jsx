        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="max-w-2xl text-left">
              <span className="text-purple-200 font-bold tracking-widest uppercase text-xs mb-4 block">Welcome to ClothStreet</span>
              ...
              <p className="mt-6 text-lg leading-8 text-purple-100 mb-8">
            ...
            <div className="hidden lg:grid grid-cols-2 gap-4">
              <div className="grid gap-4 transform translate-y-8">
                <img src="https://images.unsplash.com/photo-1537832816519-689ad163238b?auto=format&fit=crop&q=80&w=600" alt="Tailor working" className="w-full h-64 object-cover rounded-3xl shadow-2xl border-4 border-white/10" />
                <img src="https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?auto=format&fit=crop&q=80&w=600" alt="Fabrics" className="w-full h-48 object-cover rounded-3xl shadow-xl border-4 border-white/10" />
              </div>
              <div className="grid gap-4">
                <img src="https://images.unsplash.com/photo-1551232864-3f0890e580d9?auto=format&fit=crop&q=80&w=600" alt="Design tools" className="w-full h-56 object-cover rounded-3xl shadow-xl border-4 border-white/10" />
                <img src="https://images.unsplash.com/photo-1558171813-4c088753af8f?auto=format&fit=crop&w=600&q=80" alt="Fashion design" className="w-full h-72 object-cover rounded-3xl shadow-2xl border-4 border-white/10" />
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative group">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-500 font-medium">Founded In</p>
                  <p className="font-bold text-gray-900">Sri Lanka</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-12 lg:pl-8 mt-12 lg:mt-0">
              ...
              <div className="space-y-6 pt-8 border-t border-gray-100">
                ...
                <h3 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Our Vision</h3>
      ...
      <section className="py-24 bg-gray-50">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Pillar 1 */}
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 relative transform hover:-translate-y-4 group">
