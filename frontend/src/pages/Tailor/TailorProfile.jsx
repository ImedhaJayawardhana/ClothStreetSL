    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <button 
          ...
          className="flex items-center gap-2 text-gray-500 hover:text-purple-600 font-medium text-sm mb-6 transition-colors"
        >
              ...
              <div className="p-6 flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-2.5">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button onClick={() => setIsSaved(!isSaved)} className="flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl border-2 border-purple-200 text-purple-700 text-xs font-semibold hover:bg-purple-50 hover:border-purple-300 transition-colors">
                      <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} viewBox="0 0 24 24" 
