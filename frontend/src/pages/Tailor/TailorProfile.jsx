...
import { getTailor, updateTailor, uploadImage, getMyOrders } from "../../api";
...
export default function TailorProfile() {
    ...
    // Personal orders state (orders where tailor is the buyer)
    ...
    // ── Fetch personal orders (where tailor is the buyer) ──
    useEffect(() => {
