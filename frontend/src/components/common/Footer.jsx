                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
                    ...
                    <div className="space-y-6">
                        <Link to="/" className="flex items-center gap-3">
                            ...
                            <span className="text-2xl font-bold text-white tracking-tight">ClothStreet</span>
                        </Link>
                        ...
                        <div className="flex items-center gap-4 pt-2">
                            <a href="#" className="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-800/50 hover:bg-purple-600 hover:text-white transition-colors duration-300">
                    ...
                    <div className="space-y-6 lg:ml-8">
                        ...
                        <ul className="space-y-4">
                            <li><Link to="/fabrics" className="text-sm hover:text-purple-400 transition-colors">Fabric Marketplace</Link></li>
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-5">
                            <li className="flex items-start gap-4">
                                <svg className="w-5 h-5 text-purple-600 mt-0.5 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" /><circle cx="12" cy="10" r="3" /></svg>
                                <span className="text-sm leading-relaxed">No. 42, Pettah Market Complex, Colombo 11, Sri Lanka</span>
                            </li>
                            <li className="flex items-center gap-4">
                                <svg className="w-5 h-5 text-purple-600 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" /></svg>
                                <span className="text-sm">+94 11 234 5678</span>
                            </li>
                            <li className="flex items-center gap-4">
                                <svg className="w-5 h-5 text-purple-600 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></svg>
                                <a href="mailto:hello@clothstreet.lk" className="text-sm hover:text-purple-400 transition-colors">hello@clothstreet.lk</a>
                            </li>
                        </ul>
                    </div>
